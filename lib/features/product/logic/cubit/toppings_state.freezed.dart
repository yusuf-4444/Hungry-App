...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ToppingsState<T>);
}
...
/// @nodoc
class $ToppingsStateCopyWith<T,$Res>  {
$ToppingsStateCopyWith(ToppingsState<T> _, $Res Function(ToppingsState<T>) __);
}


/// Adds pattern-matching-related methods to [ToppingsState].
extension ToppingsStatePatterns<T> on ToppingsState<T> {
...
class _Initial<T> implements ToppingsState<T> {
  const _Initial();
...
@override
String toString() {
  return 'ToppingsState<$T>.initial()';
}
...
class Loading<T> implements ToppingsState<T> {
  const Loading();
...
@override
String toString() {
  return 'ToppingsState<$T>.loading()';
}
...
class Success<T> implements ToppingsState<T> {
...
@override
String toString() {
  return 'ToppingsState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $ToppingsStateCopyWith<T, $Res> {
...
class Failure<T> implements ToppingsState<T> {
...
@override
String toString() {
  return 'ToppingsState<$T>.failure(error: $error)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $ToppingsStateCopyWith<T, $Res> {
