...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SideOptionsState<T>);
}
...
/// @nodoc
class $SideOptionsStateCopyWith<T,$Res>  {
$SideOptionsStateCopyWith(SideOptionsState<T> _, $Res Function(SideOptionsState<T>) __);
}


/// Adds pattern-matching-related methods to [SideOptionsState].
extension SideOptionsStatePatterns<T> on SideOptionsState<T> {
...
class _Initial<T> implements SideOptionsState<T> {
  const _Initial();
...
@override
String toString() {
  return 'SideOptionsState<$T>.initial()';
}
...
class Loading<T> implements SideOptionsState<T> {
  const Loading();
...
@override
String toString() {
  return 'SideOptionsState<$T>.loading()';
}
...
class Success<T> implements SideOptionsState<T> {
...
@override
String toString() {
  return 'SideOptionsState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $SideOptionsStateCopyWith<T, $Res> {
...
class Failure<T> implements SideOptionsState<T> {
...
@override
String toString() {
  return 'SideOptionsState<$T>.failure(error: $error)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $SideOptionsStateCopyWith<T, $Res> {
