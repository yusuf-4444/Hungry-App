...
class Failure<T> implements UpdateProfileState<T> {
...
@override
String toString() {
  return 'UpdateProfileState<$T>.failure(error: $error)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $UpdateProfileStateCopyWith<T, $Res> {
