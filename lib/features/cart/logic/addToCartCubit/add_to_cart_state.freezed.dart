...
class Loading<T> implements AddToCartState<T> {
  const Loading();
...
class Success<T> implements AddToCartState<T> {
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $AddToCartStateCopyWith<T, $Res> {
...
class Failure<T> implements AddToCartState<T> {
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $AddToCartStateCopyWith<T, $Res> {
