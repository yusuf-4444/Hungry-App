...
@freezed
abstract class GetCartState<T> with _$GetCartState {
  ...
  const factory GetCartState.increment(T data) = Increment<T>;
  const factory GetCartState.decrement(T data) = Decrement<T>;
}
