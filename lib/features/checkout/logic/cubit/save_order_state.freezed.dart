...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is SaveOrderState<T>);
}
...
/// @nodoc
class $SaveOrderStateCopyWith<T,$Res>  {
$SaveOrderStateCopyWith(SaveOrderState<T> _, $Res Function(SaveOrderState<T>) __);
}


/// Adds pattern-matching-related methods to [SaveOrderState].
extension SaveOrderStatePatterns<T> on SaveOrderState<T> {
...
class _Initial<T> implements SaveOrderState<T> {
  const _Initial();
...
@override
String toString() {
  return 'SaveOrderState<$T>.initial()';
}
...
class Loading<T> implements SaveOrderState<T> {
  const Loading();
...
@override
String toString() {
  return 'SaveOrderState<$T>.loading()';
}
...
class Success<T> implements SaveOrderState<T> {
  const Success(this.data);
  

 final  T data;

/// Create a copy of SaveOrderState
...
@override
String toString() {
  return 'SaveOrderState<$T>.success(data: $data)';
}
...
/// @nodoc
abstract mixin class $SuccessCopyWith<T,$Res> implements $SaveOrderStateCopyWith<T, $Res> {
...
class Failure<T> implements SaveOrderState<T> {
...
@override
String toString() {
  return 'SaveOrderState<$T>.failure(error: $error)';
}
...
/// @nodoc
abstract mixin class $FailureCopyWith<T,$Res> implements $SaveOrderStateCopyWith<T, $Res> {
